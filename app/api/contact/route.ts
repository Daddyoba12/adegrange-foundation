    ...
    await resend.emails.send({
      ...
      html: `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 32px; background: #f9fafb; border-radius: 12px;">
          ...
          <p style="color: #6b7280; font-size: 14px; margin-top: 0;">AdeGrange Child Foundation Website</p>
          <hr style="border: none; border-top: 1px solid #e5e7eb; margin: 24px 0;" />

          <table style="width: 100%; border-collapse: collapse;">
            <tr>
              <td style="padding: 10px 0; color: #6b7280; font-size: 13px; width: 120px; vertical-align: top;">Full Name</td>
            ...
            <tr>
              ...
              <td style="padding: 10px 0; color: #111827; font-size: 15px;">
                <a href="mailto:${email}" style="color: #db2777;">${email}</a>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td style="padding: 10px 0; color: #6b7280; font-size: 13px; vertical-align: top; padding-top: 16px;">Message</td>
              <td style="padding: 10px 0; color: #111827; font-size: 15px; line-height: 1.6; padding-top: 16px;">${message}</td>
            </tr>
          </table>

          <hr style="border: none; border-top: 1px solid #e5e7eb; margin: 24px 0;" />
          <p style="color: #9ca3af; font-size: 12px; text-align: center;">
            This message was sent from the contact form at adegrangefoundation.org
          </p>
        </div>
      `
    })
