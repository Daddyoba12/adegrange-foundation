            ...
            >
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-4 pt-2">
                  <button className="px-6 py-2.5 bg-black dark:bg-white text-white dark:text-black font-medium rounded-lg hover:opacity-90 transition-all duration-200 hover:scale-105">
                    View Program
                  </button>
